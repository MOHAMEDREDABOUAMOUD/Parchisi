...
public class follow_the_path_y_32 : MonoBehaviour
{
    ...
    void Update()
    {
        if (firstmove2 == true && transform.position == firstplace2.position && Dice2.freeyellow)
        {
            if (Dice2.posy == 0)
            {
                if(Dice2.posy1!=0 && Dice2.posy3!=0)
                {
                    Dice2.posy2 = 0;
            ...
            x=34;
            if(follow_the_path_y_22.firstmove1==false && follow_the_path_y12.firstmove==false && follow_the_path_y_42.firstmove3==false) Dice2.freeyellow=false;
            firstmove2=false;
        }
    ...
    IEnumerator move()
    {
        if(Dice2.posy2 + Dice2.nbr == waypoints.Length)
        {
            numberImg2.hideimg();numberImg2.show = false;////////////////
            numberImg12.hideimg();numberImg12.show = false;///////////////////
            Dice2.posyLeft2 = false;
            for (int i =Dice2.posy2;i< Dice2.posy2 + Dice2.nbr ; i++)
            {
                transform.position = waypoints[i].position;
                yield return new WaitForSeconds(0.5f);
            }
            Dice2.posy2= Dice2.posy2 + Dice2.nbr;
            x=x+ Dice2.nbr;
        ...
        else if (Dice2.posy2 + Dice2.nbr <= waypoints.Length - 1)
        {
            numberImg2.hideimg(); numberImg2.show = false;////////////////
            numberImg12.hideimg(); numberImg12.show = false;///////////////////
            Dice2.posyLeft2 = false;
            ...
            for(int i=1;i<=Dice2.nbr;i++)
            {
                ...
                else if(Dice2.posy2<63)
                {
                    x++;  
                }
            }
            if (Dice2.posy == Dice2.posy2)
            {
                if (Dice2.posyLeft == true)
                {
                    transform.position = waypoints[Dice2.posy2].position;
                }
                else
                {
                    transform.position = waypoints1[Dice2.posy2].position;
                    Dice2.posyLeft2 = true;
                }
            }
            else if (Dice2.posy1 == Dice2.posy2)
            {
                if (Dice2.posyLeft1 == true)
                {
                    transform.position = waypoints[Dice2.posy2].position;
            ...
            else if (Dice2.posy3 == Dice2.posy2)
            {
                if (Dice2.posyLeft3 == true)
                {
                    transform.position = waypoints[Dice2.posy2].position;
