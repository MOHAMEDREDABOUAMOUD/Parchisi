...
public class follow_the_path_g34 : MonoBehaviour
{
    ...
    void Update()
    {
        if (firstmove2 == true && transform.position == firstplace2.position && Dice4.freegreen)
        {
            if (Dice4.posg == 0)
            {
                if(Dice4.posg1!=0 && Dice4.posg3!=0)
                {
                    Dice4.posg2 = 0;
                    ...
                    else
                    {
                        ...
                        Dice4.posgLeft2 = true;
                    }
                }
            }
            else if (Dice4.posg1 == 0)
            {
                Dice4.posg2 = 0;
                if (Dice4.posg!=0 && Dice4.posg3!=0)
                {
                    if (Dice4.posgLeft1 == true)
                    {
                        transform.position = waypoints[0].position;
                    }
                    else
            ...
            x=17;
            if(follow_the_path_g24.firstmove1==false && follow_the_path_g14.firstmove==false && follow_the_path_g44.firstmove3==false) Dice4.freegreen=false;
            firstmove2=false;
        }
    ...
    IEnumerator move()
    {
        if(Dice4.posg2 + Dice4.nbr == waypoints.Length)
        {
            numberImg4.hideimg();numberImg4.show = false;////////////////
            numberImg14.hideimg();numberImg14.show = false;///////////////////
            Dice4.posgLeft2 = false;
            for (int i =Dice4.posg2;i< Dice4.posg2 + Dice4.nbr ; i++)
            {
                transform.position = waypoints[i].position;
                yield return new WaitForSeconds(0.5f);
            }
            Dice4.posg2= Dice4.posg2 + Dice4.nbr;
            x=x+ Dice4.nbr;
        ...
        else if (Dice4.posg2 + Dice4.nbr <= waypoints.Length - 1)
        {
            numberImg4.hideimg(); numberImg4.show = false;////////////////
            numberImg14.hideimg(); numberImg14.show = false;///////////////////
            Dice4.posgLeft2 = false;
            ...
            for(int i=1;i<=Dice4.nbr;i++)
            {
                ...
                else if(Dice4.posg2<63)
                {
                    x++;  
                }
                else x=100;
            }
            if (Dice4.posg == Dice4.posg2)
            {
                if (Dice4.posgLeft == true)
                {
                    transform.position = waypoints[Dice4.posg2].position;
                }
                else
                {
                    transform.position = waypoints1[Dice4.posg2].position;
                    Dice4.posgLeft2 = true;
                }
            }
            else if (Dice4.posg1 == Dice4.posg2)
            {
                if (Dice4.posgLeft1 == true)
                {
                    transform.position = waypoints[Dice4.posg2].position;
            ...
            else if (Dice4.posg3 == Dice4.posg2)
            {
                if (Dice4.posgLeft3 == true)
                {
                    transform.position = waypoints[Dice4.posg2].position;
