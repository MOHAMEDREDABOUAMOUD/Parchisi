...
public class follow_the_path_b24 : MonoBehaviour
{
    ...
    void Update()
    {
        if (firstmove1 == true && transform.position == firstplace1.position && Dice4.freeblue)
        {
            if (Dice4.posb == 0)
            {
                if(Dice4.posb2!=0 && Dice4.posb3!=0)
                {
                    Dice4.posb1 = 0;
                    ...
                    else
                    {
                        ...
                        Dice4.posbLeft1 = true;
                    }
                }
            }
            else if (Dice4.posb2 == 0)
            {
                if(Dice4.posb!=0 && Dice4.posb3!=0)
                {
                    Dice4.posb1 = 0;
            ...
            else if (Dice4.posb3 == 0)
            {
                if(Dice4.posb!=0 && Dice4.posb2!=0)
                {
                    Dice4.posb1 = 0;
                    if (Dice4.posbLeft3 == true)
                    {
                        transform.position = waypoints[0].position;
                    }
                    else
            ...
            x=51;
            if(follow_the_path_b14.firstmove==false && follow_the_path_b34.firstmove2==false && follow_the_path_b44.firstmove3==false) Dice4.freeblue=false;
            firstmove1=false;
        }
    ...
    IEnumerator move()
    {
        if(Dice4.posb1 + Dice4.nbr == waypoints.Length)
        {
            numberImg4.hideimg();numberImg4.show = false;////////////////
            numberImg14.hideimg();numberImg14.show = false;///////////////////
            Dice4.posbLeft = false;
            for (int i =Dice4.posb1;i< Dice4.posb1 + Dice4.nbr ; i++)
            {
                transform.position = waypoints[i].position;
                yield return new WaitForSeconds(0.5f);
            }
            Dice4.posb1= Dice4.posb1 + Dice4.nbr;
            x=x+ Dice4.nbr;
        ...
        else if (Dice4.posb1 + Dice4.nbr <= waypoints.Length - 1)
        {
            numberImg4.hideimg(); numberImg4.show = false;////////////////
            numberImg14.hideimg(); numberImg14.show = false;///////////////////
            Dice4.posbLeft1 = false;
            for (int i =Dice4.posb1;i<= Dice4.posb1 + Dice4.nbr; i++)
            {
                //Time.timeScale = 1f;
                transform.position = waypoints[i].position;
            ...
            for(int i=1;i<=Dice4.nbr;i++)
            {
                ...
                else if(Dice4.posb1<63)
                {
                    x++;  
                }
                else x=100;
            }
            if (Dice4.posb == Dice4.posb1)
            {
                if (Dice4.posbLeft == true)
                {
                    transform.position = waypoints[Dice4.posb1].position;
                }
                else
                {
                    transform.position = waypoints1[Dice4.posb1].position;
                    Dice4.posbLeft1 = true;
                }
            }
            else if (Dice4.posb2 == Dice4.posb1)
            {
                if (Dice4.posbLeft2 == true)
                {
                    transform.position = waypoints[Dice4.posb1].position;
            ...
            else if (Dice4.posb3 == Dice4.posb1)
            {
                if (Dice4.posbLeft3 == true)
                {
                    transform.position = waypoints[Dice4.posb1].position;
