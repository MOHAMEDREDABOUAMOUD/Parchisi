...
public class follow_the_path_y_44 : MonoBehaviour
{
    ...
    void Update()
    {
        if (firstmove3 == true && transform.position == firstplace3.position && Dice4.freeyellow)
        {
            if (Dice4.posy == 0)
            {
            ...
            x=34;
            if(follow_the_path_y_24.firstmove1==false && follow_the_path_y_34.firstmove2==false && follow_the_path_y14.firstmove==false) Dice4.freeyellow=false;
            firstmove3=false;
        }
    ...
    IEnumerator move()
    {
        if(Dice4.posy3 + Dice4.nbr == waypoints.Length)
        {
            numberImg4.hideimg();numberImg4.show = false;////////////////
            numberImg14.hideimg();numberImg14.show = false;///////////////////
            Dice4.posyLeft = false;
            for (int i =Dice4.posy3;i< Dice4.posy3 + Dice4.nbr ; i++)
            {
                transform.position = waypoints[i].position;
                yield return new WaitForSeconds(0.5f);
            }
            Dice4.posy3= Dice4.posy3 + Dice4.nbr;
            x=x+ Dice4.nbr;
        ...
        else if (Dice4.posy3 + Dice4.nbr <= waypoints.Length - 1)
        {
            numberImg4.hideimg(); numberImg4.show = false;////////////////
            numberImg14.hideimg(); numberImg14.show = false;///////////////////
            Dice4.posyLeft3 = false;
            for (int i =Dice4.posy3 ;i<= Dice4.posy3 + Dice4.nbr; i++)
            {
                transform.position = waypoints[i].position;
                yield return new WaitForSeconds(0.1f);
            }
            Dice4.posy3 += Dice4.nbr;
            ...
            if (Dice4.posy == Dice4.posy3)
            {
                if (Dice4.posyLeft == true)
                {
                    transform.position = waypoints[Dice4.posy3].position;
                }
                else
                {
                    transform.position = waypoints1[Dice4.posy3].position;
                    Dice4.posyLeft3 = true;
                }
            }
            else if (Dice4.posy1 == Dice4.posy3)
            {
                if (Dice4.posyLeft1 == true)
                {
                    transform.position = waypoints[Dice4.posy3].position;
            ...
            else if (Dice4.posy2 == Dice4.posy3)
            {
                if (Dice4.posyLeft2 == true)
                {
                    transform.position = waypoints[Dice4.posy3].position;
