...
public class follow_the_path_y12 : MonoBehaviour
{
    ...
    void Update()
    {
        if (firstmove == true && transform.position == firstplace.position && Dice2.freeyellow)
        {
            if (Dice2.posy1 == 0)
            {
            ...
            x=34;
            if(follow_the_path_y_22.firstmove1==false && follow_the_path_y_32.firstmove2==false && follow_the_path_y_42.firstmove3==false) Dice2.freeyellow=false;
            firstmove=false;
        }
    ...
    IEnumerator move()
    {
        if(Dice2.posy + Dice2.nbr == waypoints.Length)
        {
            numberImg2.hideimg();numberImg2.show = false;////////////////
            numberImg12.hideimg();numberImg12.show = false;///////////////////
            Dice2.posyLeft = false;
            for (int i =Dice2.posy;i<Dice2.posy + Dice2.nbr; i++)
            {
                transform.position = waypoints[i].position;
                yield return new WaitForSeconds(0.1f);
            }
            Dice2.posy= Dice2.posy + Dice2.nbr;
            x=x+ Dice2.nbr;
        ...
        else if (Dice2.posy + Dice2.nbr <= waypoints.Length - 1)
        {
            numberImg2.hideimg();numberImg2.show = false;////////////////
            numberImg12.hideimg();numberImg12.show = false;///////////////////
            Dice2.posyLeft = false;
            ...
            for(int i=1;i<=Dice2.nbr;i++)
            {
                ...
                else if(Dice2.posy<63)
                {
                    x++;  
                }
            }
            if (Dice2.posy1 == Dice2.posy)
            {
                if (Dice2.posLeft1 == true)
                {
                    transform.position = waypoints[Dice2.posy].position;
                }
                else
                {
                    transform.position = waypoints1[Dice2.posy].position;
                    Dice2.posyLeft = true;
                }
            }
            else if (Dice2.posy2 == Dice2.posy)
            {
            ...
            else if (Dice2.posy3 == Dice2.posy)
            {
                if (Dice2.posyLeft3 == true)
                {
                    transform.position = waypoints[Dice2.posy].position;
