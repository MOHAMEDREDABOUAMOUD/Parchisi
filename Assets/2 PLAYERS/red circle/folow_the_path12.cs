...
public class folow_the_path12 : MonoBehaviour
{
    ...
    void Update()
    {
        if (firstmove1 == true && transform.position == firstplace1.position && Dice2.freered)
        {
            if (Dice2.pos == 0)
            {
            ...
            x=0;
            if(folow_the_pathr2.firstmove==false && folow_the_path22.firstmove2==false && folow_the_path32.firstmove3==false) Dice2.freered=false;
            firstmove1=false;
        }
    ...
    IEnumerator move()
    {
        if(Dice2.pos1 + Dice2.nbr == waypoints.Length)
        {
            numberImg2.hideimg();numberImg2.show = false;////////////////
            numberImg12.hideimg();numberImg12.show = false;///////////////////
            Dice2.posLeft = false;
            ...
            Dice2.pos1= Dice2.pos1 + Dice2.nbr;
            x=x+Dice2.nbr;
        ...
        else if (Dice2.pos1 + Dice2.nbr <= waypoints.Length - 1)
        {
            numberImg2.hideimg(); numberImg2.show = false;////////////////
            numberImg12.hideimg(); numberImg12.show = false;///////////////////
            Dice2.posLeft1 = false;
            for (int i =Dice2.pos1;i<= Dice2.pos1 + Dice2.nbr; i++)
            {
                //Time.timeScale = 1f;
                transform.position = waypoints[i].position;
            ...
            if (Dice2.pos == Dice2.pos1)
            {
                if (Dice2.posLeft == true)
                {
                    transform.position = waypoints[Dice2.pos1].position;
                }
                else
                {
                    transform.position = waypoints1[Dice2.pos1].position;
                    Dice2.posLeft1 = true;
                }
            }
            else if (Dice2.pos2 == Dice2.pos1)
            {
                if (Dice2.posLeft2 == true)
                {
                    transform.position = waypoints[Dice2.pos1].position;
