...
public class numberImg4 : MonoBehaviour
{
            ...
            if(Dice4.tour==1)
            {
                if(Dice4.selected==1)
                {
                    ...
                    if (cantmov==false) 
                    {
                        ...
                        {
                            folow_the_path4.click = true; Dice4.access1 = false;
                        }
                    }
                }
                else if(Dice4.selected==2)
                {
                    ...
                    if (cantmov==false)
                    {
                        ...
                        {
                            folow_the_path14.click = true; Dice4.access1 = false;
                        }
                    }
                }
                else if(Dice4.selected==3)
                {
                    ...
                    if (cantmov==false)
                    {
                        ...
                        {
                            folow_the_path24.click = true; Dice4.access1 = false;
                        }
                    }
                }
                else if(Dice4.selected==4)
                {
                    ...
                    if (cantmov==false)
                    {
                        ...
                        {
                            folow_the_path34.click = true; Dice4.access1 = false;
                        }
                    }
                }
                else
            ...
            else if(Dice4.tour==2)
            {
                if(Dice4.selectedy==1)
                {
                    ...
                    if (cantmov==false) 
                    {
                        ...
                        {
                            follow_the_path_y14.click = true; Dice4.access1 = false;
                        }
                    } 
                }
                else if(Dice4.selectedy==2)
                {
                    ...
                    if (cantmov==false)
                    {
                        ...
                        {
                            follow_the_path_y_24.click = true; Dice4.access1 = false;
                        }
                    }
                }
                else if(Dice4.selectedy==3)
                {
                    ...
                    if (cantmov==false)
                    {
                        ...
                        {
                            follow_the_path_y_34.click = true; Dice4.access1 = false;
                        }
                    }
                }
                else if(Dice4.selectedy==4)
                {
                    ...
                    if (cantmov==false)
                    {
                        ...
                        {
                            follow_the_path_y_44.click = true; Dice4.access1 = false;
                        }
                    }
                }
                else
            ...
            else if(Dice4.tour==3)
            {
                if(Dice4.selectedg==1)
                {
                    ...
                    if (cantmov==false) 
                    {
                        if(Dice4.posg+Dice4.nbr<=follow_the_path_g14.Length)
                        {
                            ...
                            follow_the_path_g14.click = true; Dice4.access1 = false;
                        }
                    } 
                }
                else if(Dice4.selectedg==2)
                {
                    ...
                    if (cantmov==false)
                    {
                        ...
                        {
                            follow_the_path_g24.click = true; Dice4.access1 = false;
                        }
                    }
                }
                else if(Dice4.selectedg==3)
                {
                    ...
                    if (cantmov==false)
                    {
                        ...
                        {
                            follow_the_path_g34.click = true; Dice4.access1 = false;
                        }
                    }
                }
                else if(Dice4.selectedg==4)
                {
                    ...
                    if (cantmov==false)
                    {
                        ...
                        {
                            follow_the_path_g44.click = true; Dice4.access1 = false;
                        }
                    }
                }
                else
            ...
            else
            {
                if(Dice4.selectedb==1)
                {
                    ...
                    if (cantmov==false) 
                    {
                        if(Dice4.posb+Dice4.nbr<=Dice4.l)
                        {
                            ...
                            follow_the_path_b14.click = true; Dice4.access1 = false;
                        }
                    } 
                }
                else if(Dice4.selectedb==2)
                {
                    ...
                    if (cantmov==false)
                    {
                        ...
                        {
                            follow_the_path_b24.click = true; Dice4.access1 = false;
                        }
                    }
                }
                else if(Dice4.selectedb==3)
                {
                    ...
                    if (cantmov==false)
                    {
                        ...
                        {
                            follow_the_path_b34.click = true; Dice4.access1 = false;
                        }
                    }
                }
                else if(Dice4.selectedb==4)
                {
                    ...
                    if (cantmov==false)
                    {
                        ...
                        {
                            follow_the_path_b44.click = true; Dice4.access1 = false;
                        }
                    }
                }
                else
