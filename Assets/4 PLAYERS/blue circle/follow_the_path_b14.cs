...
public class follow_the_path_b14 : MonoBehaviour
{
    ...
    void Update()
    {
        if (firstmove == true && transform.position == firstplace.position && Dice4.freeblue)
        {
            ...
            x=51;
            if(follow_the_path_b24.firstmove1==false && follow_the_path_b34.firstmove2==false && follow_the_path_b44.firstmove3==false) Dice4.freeblue=false;
            firstmove=false;
        }
    ...
    IEnumerator move()
    {
        if(Dice4.posb + Dice4.nbr == waypoints.Length)
        {
            numberImg4.hideimg();numberImg4.show = false;////////////////
            numberImg14.hideimg();numberImg14.show = false;///////////////////
            Dice4.posbLeft = false;
            for (int i =Dice4.posb;i<Dice4.posb + Dice4.nbr; i++)
            {
                transform.position = waypoints[i].position;
                yield return new WaitForSeconds(0.1f);
            }
            Dice4.posb= Dice4.posb + Dice4.nbr;
            x=x+ Dice4.nbr;
        ...
        else if (Dice4.posb + Dice4.nbr <= waypoints.Length - 1)
        {
            numberImg4.hideimg();numberImg4.show = false;////////////////
            numberImg14.hideimg();numberImg14.show = false;///////////////////
            Dice4.posbLeft = false;
            ...
            for(int i=1;i<=Dice4.nbr;i++)
            {
                ...
                else if(Dice4.posb<63)
                {
                    x++;  
                }
                else x=100;
            }
            if (Dice4.posb1 == Dice4.posb)
            {
                if (Dice4.posbLeft1 == true)
                {
                    transform.position = waypoints[Dice4.posb].position;
                }
                else
                {
                    transform.position = waypoints1[Dice4.posb].position;
                    Dice4.posbLeft = true;
                }
            }
            else if (Dice4.posb2 == Dice4.posb)
            {
                if (Dice4.posbLeft2 == true)
                {
                    transform.position = waypoints[Dice4.posb].position;
            ...
            else if (Dice4.posb3 == Dice4.posb)
            {
                if (Dice4.posbLeft3 == true)
                {
                    transform.position = waypoints[Dice4.posb].position;
