...
public class folow_the_path34 : MonoBehaviour
{
    ...
    void Update()
    {
        if (firstmove3 == true && transform.position == firstplace3.position && Dice4.freered)
        {
            if (Dice4.pos == 0)
            {
            ...
            x=0;
            if(folow_the_path14.firstmove1==false && folow_the_path24.firstmove2==false && folow_the_path4.firstmove==false) Dice4.freered=false;
            firstmove3=false;
        }
    ...
    IEnumerator move()
    {
        if(Dice4.pos3 + Dice4.nbr == waypoints.Length)
        {
            numberImg4.hideimg();numberImg4.show = false;////////////////
            numberImg14.hideimg();numberImg14.show = false;///////////////////
            Dice4.posLeft = false;
            for (int i =Dice4.pos3;i< Dice4.pos3 + Dice4.nbr ; i++)
            {
                transform.position = waypoints[i].position;
                yield return new WaitForSeconds(0.5f);
            }
            Dice4.pos3= Dice4.pos3 + Dice4.nbr;
            x=x+ Dice4.nbr;
        ...
        else if (Dice4.pos3 + Dice4.nbr <= waypoints.Length - 1)
        {
            numberImg4.hideimg(); numberImg4.show = false;////////////////
            numberImg14.hideimg(); numberImg14.show = false;///////////////////
            Dice4.posLeft3 = false;
            for (int i =Dice4.pos3 ;i<= Dice4.pos3 + Dice4.nbr; i++)
            {
                transform.position = waypoints[i].position;
                yield return new WaitForSeconds(0.1f);
            }
            Dice4.pos3 += Dice4.nbr;
            ...
            if (Dice4.pos == Dice4.pos3)
            {
                if (Dice4.posLeft == true)
                {
                    transform.position = waypoints[Dice4.pos3].position;
                }
                else
                {
                    transform.position = waypoints1[Dice4.pos3].position;
                    Dice4.posLeft3 = true;
                }
            }
            else if (Dice4.pos1 == Dice4.pos3)
            {
                if (Dice4.posLeft1 == true)
                {
                    transform.position = waypoints[Dice4.pos3].position;
